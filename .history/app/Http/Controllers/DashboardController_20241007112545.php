...
//        dd($filterByUser);
    ...
    public function saveIntegrity(Request $request)
    {
        ...
        Alert::success('Berhasil', 'Pakta integritas berhasil disimpan');
    ...
    public function delete($id)
    {
        ...
        Alert::success('Behasil', 'Dashboard Berhasil di hapus.');
    ...
    public function update(Request $request, $id)
    {
        ...
        Alert::success('Behasil', 'Dashboard Behasil di perbaharui');
    ...
    public function store(Request $request)
    {
        ...
        Alert::success('Behasil', 'Dashboard Berhasil di buat.');
